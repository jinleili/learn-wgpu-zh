...
pub fn perspective_mvp(viewport: Size<f32>) -> (glam::Mat4, glam::Mat4, FullscreenFactor) {
...
pub fn fullscreen_factor(viewport: Size<f32>, fovy: f32) -> FullscreenFactor {
    // 缩放到贴合屏幕
    let mut sx: f32 = 1.0;
    let mut sy = 1.0;
...
pub fn ortho_mvp(viewport_size: Size<f32>) -> (glam::Mat4, glam::Mat4) {
