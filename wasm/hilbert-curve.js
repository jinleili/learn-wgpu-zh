...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_44d3ea17ff85a93d = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 56, function: Function { arguments: [NamedExternref("Array<any>"), NamedExternref("ResizeObserver")], shim_idx: 67, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_1350, __wasm_bindgen_func_elem_850);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_cast_510d10fc6d03d2f7 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 56, function: Function { arguments: [], shim_idx: 73, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_1350, __wasm_bindgen_func_elem_2558);
        return addHeapObject(ret);
    };
